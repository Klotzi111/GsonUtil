...
public class GsonUpdater {
	...
	/**
	 * Updates {@code target} object from the {@code json} object. Only fields existing in {@code json} are affected.
	...
	public static void updateObjectRaw(Gson gson, Object target, JsonObject json, boolean failFast) throws Exception {
		Map<String, BoundField> boundFields = BoundFieldHelper.getBoundFields(gson, TypeToken.get(target.getClass()));
